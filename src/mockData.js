...
function generateMockRaces() {
  ...
  return [
    ...
    },
    {
      ...
      runners: [
        makeRunner(1, 'Celtic Whirlwind', 'A. Samuels',  '2-1-3-2-1', 3.75,  0.00, ['attheraces'], { attheraces: 1 }),
        makeRunner(2, 'Ballybeg Diamond', 'B. Sheridan', '1-3-2-1-3', 4.00, +0.50, ['timeform', 'attheraces'], { timeform: 1, attheraces: 2 }),
    ...
    },
    {
      ...
      runners: [
        ...
        makeRunner(3, 'Outdoor Survivor', 'A. Samuels',  '4-1-3-4-2', 6.50, +0.75, ['timeform', 'attheraces'], { timeform: 1, attheraces: 2 }),
        makeRunner(4, 'Nolas Legacy',     'B. Sheridan', '2-4-4-1-3', 4.50,  0.00, ['attheraces'], { attheraces: 2 }),
    ...
    // ── SHEFFIELD ─────────────────────────────────────────────────────────────
    {
      ...
      runners: [
        ...
        makeRunner(2, 'Droopys Jet',      'P. Young',    '1-1-2-1-2', 2.90, -0.10, ['timeform', 'attheraces'], { timeform: 1, attheraces: 1 }),
        makeRunner(3, 'Antigua Star',     'D. Dark',     '3-2-3-3-1', 4.50, +1.00, []),
        makeRunner(4, 'Ballybeg Storm',   'M. Wallis',   '4-4-1-4-3', 7.50, +0.50, ['attheraces'], { attheraces: 2 }),
    ...
    },
    {
      ...
      runners: [
        makeRunner(1, 'Pennys Whisper',   'J. Mullins',  '1-2-2-1-1', 3.00,  0.00, ['attheraces'], { attheraces: 1 }),
        makeRunner(2, 'Toolmaker Jack',   'C. Buckland', '3-3-3-4-3', 8.00, +1.50, ['timeform', 'attheraces'], { timeform: 2, attheraces: 1 }),
    ...
    },
    {
      ...
      runners: [
        ...
        makeRunner(3, 'Magical Bex',      'J. Mullins',  '2-2-1-2-3', 3.80, +0.70, ['timeform', 'attheraces'], { timeform: 2, attheraces: 1 }),
        makeRunner(4, 'Ballymac Bose',    'C. Buckland', '4-3-4-4-2', 7.00,  0.00, ['attheraces'], { attheraces: 2 }),
    ...
    // ── NOTTINGHAM ────────────────────────────────────────────────────────────
    {
      ...
      runners: [
        makeRunner(1, 'Coppice Tiger',    'D. Dark',     '3-2-4-3-2', 5.00, +0.50, ['timeform', 'attheraces', 'racingpost'], { timeform: 1, attheraces: 1, racingpost: 2 }),
        ...
        makeRunner(5, 'Silverhill Ava',   'J. Mullins',  '2-2-2-3-2', 3.75,  0.00, ['attheraces'], { attheraces: 2 }),
    ...
    },
    {
      ...
      runners: [
        ...
        makeRunner(2, 'Burgess Remus',    'P. Young',    '3-3-1-3-3', 6.00, +1.20, ['timeform', 'attheraces'], { timeform: 2, attheraces: 1 }),
        makeRunner(3, 'Slippy Harold',    'D. Dark',     '2-2-3-1-2', 4.00,  0.00, ['attheraces'], { attheraces: 1 }),
    ...
    // ── HOVE ──────────────────────────────────────────────────────────────────
    {
      ...
      runners: [
        makeRunner(1, 'Puttfor Teddi',    'J. Mullins',  '2-3-2-2-3', 4.80,  0.00, ['attheraces'], { attheraces: 1 }),
        makeRunner(2, 'Gentle Ranger',    'C. Buckland', '1-2-1-1-1', 2.70,  0.00, []),
        makeRunner(3, 'Ballymac Posh',    'S. Cahill',   '3-1-3-3-2', 5.20, +1.30, ['timeform', 'attheraces', 'racingpost'], { timeform: 1, attheraces: 1, racingpost: 2 }),
    ...
    },
    {
      ...
      runners: [
        ...
        makeRunner(2, 'Makeit Monalisa',  'B. Sheridan', '3-2-2-3-2', 4.20, +0.80, ['timeform', 'attheraces', 'racingpost'], { timeform: 2, attheraces: 1, racingpost: 1 }),
        makeRunner(3, 'Swithins Rex',     'J. Mullins',  '2-3-3-1-3', 5.50,  0.00, []),
        makeRunner(4, 'Droopys Maldini',  'C. Buckland', '4-4-1-4-4', 8.50, -1.50, ['attheraces'], { attheraces: 2 }),
